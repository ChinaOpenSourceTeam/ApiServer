package com.chinaopensource.apiserver.common.util.image;
...
public class PictureGeneratorUtil {
     ...
     * @throws IOException
     */
    public static void generatorImage(HttpServletRequest request, HttpServletResponse response,Integer width,Integer height)throws IOException{
        //1.在内存中创建一张图片
...
//        String random = drawRandomNum((Graphics2D) g,createTypeFlag);//根据客户端传递的createTypeFlag标识生成验证码图片
     ...
     * @param g
     */
    private static void setBackGround(Graphics g,Integer width,Integer height) {
        // 设置颜色
     ...
     * @param g
     */
    private static void setBorder(Graphics g,Integer width,Integer height) {
        // 设置边框颜色
     ...
     * @param g
     */
    private static void drawRandomLine(Graphics g,Integer width,Integer height) {
